...
namespace MainMusicStore.Utility
{
    public static class ProjectConstant
    {
        ...
        public const string OrderStatusInProcess = "In Process";
        public const string StatusShipped = "Shipped";
        public const string StatusCancelled = "Cancelled";
        public const string StatusRefund = "Refund";

        public static double GetPriceBaseOnQuentity(int quantity, double price, double price50, double price100)
        {
            if (quantity < 50)
            {
                return price;
