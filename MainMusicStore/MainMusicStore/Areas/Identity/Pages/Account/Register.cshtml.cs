...
namespace MainMusicStore.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager, ILogger<RegisterModel> logger, IEmailSender emailSender, RoleManager<IdentityRole> roleManager, IUnitOfWork unitOfWork)
        {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new InputModel()
            {
                ...
                RoleList = _roleManager.Roles.Where(r => r.Name != ProjectConstant.Role_User_Indi).Select(i => i.Name).Select(i => new SelectListItem
                {
                    Text = i,
                    Value = i
                })
